...
class TableCreateAdditionProperties extends Migration
{
    ...
    public function up()
    {
        if(Schema::hasTable('lovata_orders_shopaholic_addition_properties')) {
            return;
        }

        Schema::create('lovata_orders_shopaholic_addition_properties', function(Blueprint $obTable)
        {
    ...
    {
        Schema::dropIfExists('lovata_orders_shopaholic_addition_properties');
    }
}